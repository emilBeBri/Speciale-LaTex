...
% \citefulltitle, on the other hand, always prints the 'title'
% field.

See also: \citefulltitle{companion}.

\citefulltitle{companion} by \citeauthor{companion} was
...
% \citefulltitle command shown above is similar to the following
