...
%
\begin{quote} \small %\raggedright %(bloktekst on/off)
One cannot understand what is going on without reconstructing the laws specific to this particular universe, which, with its lines of force tied to a particular distribution of specific kinds of capital (economic, symbolic, cultural, and so on), provides the principle for the strategies adopted by different producers, the alliances they make, the schools they found, and the art they defend. \sourceatright{ \parencite[544]{Bourdieu1988}				}
\end{quote}
%
