...
%  - feltanalysestrategi
%  - operationalisering
%  Analysedel 1: præsentation
%  - Det store kort - hvad er de umiddelbare findings
%  - kort teoretisk diskussion og fokus på hvad der kendetegner segmenterne

  %  Metode:
  % -registerdata
  %  - DISCO kategorier
  %  - de andre variable
  % - MONECA-metode og netværksanalyse
  %    - herunder udregning af RR
  % - videnskabsteori (Emirbayer-Jens kombo)
%  
